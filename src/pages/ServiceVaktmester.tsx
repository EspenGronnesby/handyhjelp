...
const ServiceVaktmester = () => {
  ...
  return (
    <div className="min-h-screen pt-20 lg:pt-40">
      ...
      {/* Hero — bilde + tittel */}
      <div
        className={`relative h-[280px] md:h-[500px] bg-center bg-no-repeat overflow-hidden transition-opacity duration-500 ${loading ? 'opacity-0' : 'opacity-100'}`}
        style={{ backgroundImage: `url(${heroImage})`, backgroundSize: '85%', boxShadow: 'inset 0 0 80px 35px rgba(0,0,0,0.85)' }}
      >
