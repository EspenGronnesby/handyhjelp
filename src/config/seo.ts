...
export const PAGE_SEO_DATA: Record<string, PageSEOData> = {
  '/': {
    path: '/',
    title: 'HandyHjelp – Vaktmester, Tømrer & Blikk i Kristiansand',
  ...
  '/tjenester/vaktmester': {
    ...
    title: 'Vaktmester Kristiansand | Eiendomspleie – HandyHjelp',
  ...
  '/tjenester/tomrer': {
    ...
    title: 'Tømrer Kristiansand | Terrasser & Vinduer – HandyHjelp',
  ...
  '/tjenester/blikk': {
    ...
    title: 'Blikkenslager Kristiansand | Takrenner – HandyHjelp',
  ...
  '/tjenester/takrennerens': {
    ...
    title: 'Takrennerens Kristiansand | Fast pris – HandyHjelp',
  ...
  '/om-oss': {
    path: '/om-oss',
    title: 'Om HandyHjelp | Håndverkspartner i Kristiansand',
