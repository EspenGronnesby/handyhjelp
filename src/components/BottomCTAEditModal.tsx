...
interface BottomCTAEditModalProps {
  isOpen: boolean;
  onClose: () => void;
  section: string;
  currentData: {
...
export const BottomCTAEditModal = ({
  isOpen,
  onClose,
  section,
  currentData
}: BottomCTAEditModalProps) => {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      toast({
        title: "✅ Lagret",
        description: "Bottom CTA oppdatert",
      });
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[600px] max-h-[80vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Rediger CTA-seksjon</DialogTitle>
        </DialogHeader>
