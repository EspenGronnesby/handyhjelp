...
const handler = async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    const emailResponse = await resend.emails.send({
      ...
      to: [customerEmail],
      subject: "Vi har startet arbeidet på ditt prosjekt! 🛠️",
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          <h2 style="color: #0891B2;">Hei ${customerName}!</h2>
          
          <p>Vi vil gjerne informere deg om at våre dyktige håndverkere har begynt arbeidet på ditt prosjekt.</p>
          ...
          <p>Du vil motta en ny e-post fra oss når arbeidet er ferdigstilt.</p>
    ...
    console.log("Job started email sent successfully:", emailResponse);
    ...
    console.error("Error in send-job-started-email function:", error);
    return new Response(
