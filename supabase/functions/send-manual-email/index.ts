...
function generateEmailHtml(
  ...
  const websiteFeedbackUrl = 'https://handyhjelp.no/tilbakemelding';
  
  const feedbackButtonHtml = includeFeedbackButton ? `
    <div style="text-align: center; margin: 30px 0;">
      <a href="${googleReviewUrl}" 
         style="display: inline-flex; align-items: center; gap: 8px; background: linear-gradient(135deg, #0891B2 0%, #06B6D4 100%); color: white; padding: 14px 28px; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 16px;">
    ...
    <p style="font-size: 14px; color: #6b7280; text-align: center; margin-top: 0;">
      eller <a href="${websiteFeedbackUrl}" style="color: #0891b2; text-decoration: underline;">gi tilbakemelding på nettsiden</a>
    </p>
  ` : '';
